...
<asp:PlaceHolder runat="Server" ID="phAddComment">
 <%--   <div id="comment-form">
        ...
        <div class="commentForm">
            ...
            <input type="text" name="<%= NameInputId %>" id="<%= NameInputId %>" tabindex="2"
                value="<%= DefaultName %>" />
            <span id="spnNameRequired" style="color: Red; display: none;">
                <asp:Literal runat="server" Text="<%$Resources:labels, required %>"></asp:Literal></span>
            <span id="spnChooseOtherName" style="color: Red; display: none;">
                <asp:Literal runat="server" Text="<%$Resources:labels, chooseOtherName %>"></asp:Literal></span><br />
            ...
            <label for="<%=txtWebsite.ClientID %>">
                <%=Resources.labels.website %></label>
            ...
            <input type="button" id="btnSaveAjax" value="<%=Resources.labels.saveComment %>"
                onclick="return BlogEngine.validateAndSubmitCommentForm()" tabindex="7" />
