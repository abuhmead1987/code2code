<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerNewsEditor.aspx.cs" ValidateRequest="false"
    MasterPageFile="~/Amincp/MP/MasterPageAdmin.Master" Inherits="PGFine.Amincp.ManagerNewsEditor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" width="95%" align="center">
        ...
        <tr>
            <td class="FieldTD">
                <span class="FieldCaption">Loại tin tức tiếng anh:</span>
            </td>
            <td>
                <asp:DropDownList ID="cboNameNewsVN" runat="server" CssClass="Dropdown" AutoPostBack="True"
                    OnSelectedIndexChanged="cboNameNewsVN_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td>
            </td>
        ...
        <tr>
            <td class="FieldTD">
                <span class="FieldCaption">Tiêu đề tiếng anh:</span>
            </td>
            <td>
        ...
        <tr>
            <td class="FieldTD">
                <span class="FieldCaption">Tiêu đề tiếng việt:</span>
            </td>
            <td>
