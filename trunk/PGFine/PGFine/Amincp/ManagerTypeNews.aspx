<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerTypeNews.aspx.cs"
    Title="Admin quản lý loại tin tức!" MasterPageFile="~/Amincp/MP/MasterPageAdmin.Master"
    Inherits="PGFine.Amincp.ManagerTypeNews" %>
        ...
        <tr>
            <td>
                ...
                <asp:DataGrid ID="_grid" runat="server" Width="100%" AutoGenerateColumns="False"
                    AllowPaging="True" DataKeyField="TypeNewsID" CssClass="dgGrid" ShowFooter="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ImageUrl="../Images/Edit.gif" AlternateText="Edit Record" CommandName='<%# Eval("TypeNewsID").ToString() %>'
                        ...
                        <asp:TemplateColumn HeaderText="Mã" SortExpression="id">
                            <ItemTemplate>
                                <asp:Label ID="Label1" Text='<%# DataBinder.Eval(Container.DataItem, "TypeNewsID") %>'
                                    runat="server" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Loại tin tức bằng tiếng anh" SortExpression="noidung">
                            <ItemTemplate>
                ...
                <div id="divFilter" runat="server" class="filterBox">
                    <table border="0">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblCritNoidung" runat="server">Tin tức tiếng Anh:</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server">Tin tức tiếng Việt:</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnClear" runat="server" Text="Xem hết" CssClass="Button" OnClick="btnClear_Click"
