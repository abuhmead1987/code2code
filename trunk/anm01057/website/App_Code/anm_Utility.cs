    ...
    public class anm_Utility
    {
        ...
        public static string GetWebAppRoot()
        {
            ...
            if (HttpContext.Current.Request.ApplicationPath == "/")
                return protocol + HttpContext.Current.Request.Url.Host;
            else
                return protocol + HttpContext.Current.Request.Url.Host +":" + port + HttpContext.Current.Request.ApplicationPath;
        }

        public static string RNA(string text)
        {
            anm_Utility ut = new anm_Utility();
