...
<div id="anm_" class="anm" runat="server">
    <div class="loginmaster">
        <uc1:LoginMaster ID="LoginMaster1" runat="server" />
        ||
        <asp:HyperLink ID="rssbutton" runat="server">
            <asp:Image ID="Image1" ImageUrl="~/images/rss.gif" BorderWidth="0px" Height="12px"
                AlternateText="rss" runat="server" /></asp:HyperLink>
    </div>
    ...
    <div id="anmfooter" class="anmfooter">
        <div class="fmenu">
            ...
            |
            <asp:HyperLink ID="Hlrss" Text="<%$ Resources:language, Subscribe%>" runat="server"></asp:HyperLink>
            |
            <asp:LoginStatus ID="LoginStatus1" runat="server" />
        </div>
        Powered by
        <asp:HyperLink ID="HLref" NavigateUrl="http://www.allnewsmanager.net" Text="AllNewsManager.NET"
            runat="server"></asp:HyperLink>
        <asp:Label ID="lblTemp" runat="server" Text="- Template by"></asp:Label>
        <asp:HyperLink ID="HLTemp" runat="server"></asp:HyperLink><br />
